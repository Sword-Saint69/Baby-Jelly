...
`Locomotion.onJump` fires when the grounded jump or the mid-air bonus hop
applies its Space impulse. It is not emitted by the swing, trampoline, grabs,
or any other facility. A worn item then enters a short one-dimensional free-flight state
