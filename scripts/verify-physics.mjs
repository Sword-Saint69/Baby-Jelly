...
// Skin-attached character volumes (ears/snouts/tails) draw with the body pass.
for(const object of baby.group.children)if(object!==baby.mesh&&!object.userData.isCharacterFeature) {
